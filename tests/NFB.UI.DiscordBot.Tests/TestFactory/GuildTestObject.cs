namespace NFB.UI.DiscordBot.Tests.TestFactory
{
    ...
    public class GuildTestObject : IGuild
    {
        ...
        public IList<ICategoryChannel> CategoryChannels { get; set; } = new List<ICategoryChannel>();
        ...
        public virtual Task<IVoiceChannel> CreateVoiceChannelAsync(string name, Action<VoiceChannelProperties> func)
        {
            throw new NotImplementedException();
        }
